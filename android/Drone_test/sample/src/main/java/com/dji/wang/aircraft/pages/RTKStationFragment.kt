...
import com.dji.wang.aircraft.data.DJIRTKBaseStationConnectInfo
import com.dji.wang.aircraft.data.RtkStationScanAdapter
import com.dji.wang.aircraft.databinding.FragStationRtkPageBinding
import com.dji.wang.aircraft.models.RTKStationVM
...
class RTKStationFragment : DJIFragment(), RtkStationScanAdapter.OnItemClickListener {
    ...
    private fun DJIRTKBaseStationConnectInfo.refresh(connectState: RTKStationConnetState?) {
        connectState?.let {
            LogUtils.i(com.dji.wang.aircraft.pages.RTKStationFragment.TAG, "connectState=$connectState")
