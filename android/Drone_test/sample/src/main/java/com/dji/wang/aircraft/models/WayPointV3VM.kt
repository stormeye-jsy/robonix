...
import com.dji.wang.aircraft.data.FlightControlState
import com.dji.wang.aircraft.data.MissionUploadStateInfo
        ...
        return if (isGoogleMapsSupported()) {
            ArrayAdapter<String>(
                ...
                ContextUtil.getContext().resources.getStringArray(
                    com.dji.wang.aircraft.R.array.maps_array_all
                )
            )
        } else {
            ArrayAdapter<String>(
                ...
                R.layout.simple_spinner_dropdown_item,
                ContextUtil.getContext().resources.getStringArray(
                    com.dji.wang.aircraft.R.array.maps_array
                )
            )
        }
    }
