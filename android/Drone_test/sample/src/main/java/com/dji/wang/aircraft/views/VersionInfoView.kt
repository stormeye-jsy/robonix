package com.dji.wang.aircraft.views
...
import com.dji.wang.aircraft.data.source.VersionInfo
import com.dji.wang.aircraft.databinding.LayoutVersionInfoBinding
import com.dji.wang.aircraft.models.VersionInfoVm
        ...
        binding.itemLatestVersionInfo.setOnClickListener {
            ...
            DialogUtil.showTwoButtonDialog(context, StringUtils.getResStr(R.string.news_dialog_content_tips),
                StringUtils.getResStr(R.string.news_dialog_btn_left), {
                    com.dji.wang.aircraft.util.Helper.startBrowser(context, StringUtils.getResStr(R.string.release_node_url))
